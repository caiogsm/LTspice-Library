...
TEXT -94 -34 Left 3 sin
TEXT -128 -51 Left 2 r
SYMATTR SpiceModel SineRad
SYMATTR Description The input of the sine function block is in radian. The output is equal to the sine of the input.
