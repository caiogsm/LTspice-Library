...
TEXT -97 -35 Left 3 cos
SYMATTR SpiceModel Cosine
SYMATTR Description The input of the cosine function block is in degree. The output is equal to the cosine of the input.
